 ...
 * 3. Enums & System Types - Zod enum schemas tying into database/routing constants.
...
// 1. Messages & I18N
// ---------------------------------------------------------------------------
// Defines the keys required for internationalising validation errors.
...
// ---------------------------------------------------------------------------
// Factory functions that accept a translation hook to return localised errors.
...
/** Standard URL-friendly slug validation. */
...
export const paginationSchema = z.object({
  ...
  limit: z.coerce.number().int().min(1).max(50).catch(10), // Limit per page for DoS protection.
});
...
/** Standardised privacy toggles for user profiles. */
...
export const preferencesSchema = z.object({
  ...
  language: z.enum(LOCALES).default(DEFAULT_PREFERENCES.language),
  notifications: z
    .object({
      email: z
        .object({
