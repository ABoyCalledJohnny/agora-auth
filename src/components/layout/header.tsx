...
export function Header() {
  return (
    <header id="masthead" className="sticky top-0 z-40 border-b border-neutral-200 bg-white">
      <Container className="flex h-18 items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link href="/login" className="text-neutral-600 transition-colors hover:text-teal-500">
