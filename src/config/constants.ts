 ...
 *
 * Global configuration constants and defaults, organised into logical sections:
...
// 32 bytes of high-entropy data encoded as base64url are always exactly 43 characters long.
...
// 6. Security & Logging
// ---------------------------------------------------------------------------
/** Object keys that are automatically redacted in server logs to prevent sensitive data leaks. */
